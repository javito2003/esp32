...
String webhook_endpoint = "http://192.168.55.28:3001/api/getdevicecredentials";
const char* mqtt_server = "192.168.55.28";

//PINS 
#define led 2

//WiFi
const char *wifi_ssid = "Wifi -- Moreno S";
const char *wifi_password = "LuiSRG@rci@";
